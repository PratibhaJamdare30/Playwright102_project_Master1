...
namespace Playwright102_project
{
    public class Tests
    {
        ...
        public async Task Setup()
        {
            ...
            capabilities.Add("video", true);
            capabilities.Add("visual", true);
            capabilities.Add("network", true);
            capabilities.Add("console", "true");
            ...
            string capabilitiesJsson = JsonConvert.SerializeObject(capabilities);
            string cdpUrl = "wss://cdp.lambdatest.com/plywright?capabilities= " + Uri.EscapeDataString(capabilitiesJsson);
        }
